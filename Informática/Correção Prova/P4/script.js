...
do {
    ...
    bonusLiquido = 1200 - desconto;
    alert(`Operador ${nome}. \nFaixa ${faixa}. \nDesperdício de ${desperdicio}kg. \nDesconto de R$:${desconto.toFixed(2)}. \nBônus Líquido de R$:${bonusLiquido.tiFixed(2)}.`);
    if (faixa == "eficiente") {
    ...
    do {
        continuar = prompt("Deseja continuar? Digite s ou n");
...
alert(`A média dos bônus dos operadores é de R$:${media.toFixed(2)}. \nO percentual de operadores efixientes é de ${percentualOperadoresEficientes}%.`);